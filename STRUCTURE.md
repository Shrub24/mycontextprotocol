...
- **mycontextprotocol-db** (database) - PostgreSQL with pgvector and AGE
...
- **Helmfile**: Multi-environment deployment management (app/data plane in `mycontextprotocol`)
- **Kustomize**: Environment-specific customizations
- **SOPS**: Secret encryption and management for external API keys
...
- **Containers**: nix2container for reproducible images
